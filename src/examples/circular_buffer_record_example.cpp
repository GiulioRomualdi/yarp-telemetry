...
using namespace telemetry;
 ...
 int main()
 {
    ...
    boost::circular_buffer<telemetry::Record<int32_t>> cb_i(3);
    ...
    boost::circular_buffer<telemetry::Record<double>> cb_d(3);
    ...
    boost::circular_buffer<telemetry::Record<double>> cb_v(3);
